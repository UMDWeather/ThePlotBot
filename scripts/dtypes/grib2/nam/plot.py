...
initday = filepath[6]
initday = initday[4:]
timestep = gribfile[25:-11]
inithour = gribfile[5:-31]
...
plugins=[]
for p in glob('/home/plotbot/scripts/dtypes/grib2/nam/plot_plugins/[a-zA-Z]*py'):
...
for d in domains:
  ...
  for p in plugins:
    ...
    ax.annotate('NAM 4km CONUS Nest', xy=(0,1.01), xycoords=('axes fraction'), horizontalalignment='left',
