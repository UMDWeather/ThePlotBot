...
res = filesplit[2]
domain = filesplit[3]
goodlist = ['EAST-CONUS-TIGE01','EAST-CONUS-TIGE05','EAST-CONUS-TIGE02','EAST-CONUS-TIGE04','EAST-CONUS-TIGE06']
...
for d in domains:
  if d == '01': # conus-ish
      m= Basemap(llcrnrlon=-110,llcrnrlat=22,urcrnrlon=-60,urcrnrlat=50, rsphere=(earthrad,earthrad),
