...
#
# $Id: master.mk.in,v 1.55 2008/04/07 20:25:16 steve Exp $
...
# Distributions:
############################################################################
FTPDIR		= /home/ftp/pub/netcdf-perl
FTPBINDIR	= @FTPBINDIR@
VERSION		= 1.2.4
TARFLAGS	= -chof

tag:
	@tag=$(PACKAGE)-`sed 's/\./_/g' VERSION`; \
	cvs tag -F $$tag .
...
$(PACKAGE)-$(VERSION).tar.gz:	FORCE
	dir=$(PACKAGE)-$(VERSION); \
	srcdir=$$dir/src; \
	pax -x ustar -w -s ";^;$$srcdir/;" < MANIFEST | gzip -c >$@
